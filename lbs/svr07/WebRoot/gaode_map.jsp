...
if (cid==null) return;
String sql="select f_motor_cid_latest_loc("+cid+")";  // f_motor_web_loc2("+cid+",0)" ;
...
<div style="display: none;heght:0px; position:absolute; ">
	...
	<form name="menu_schedule3" id="menu_schedule3" action="refresh2.jsp" method="post" target="frm_bottom3">		
